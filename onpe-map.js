...
const endpoints = {
  ...
  continentesExterior: API_BASE + '/ubigeos/departamentos?idEleccion=10&idAmbitoGeografico=2',
  mapaCalorExterior: API_BASE + '/resumen-general/mapa-calor?idAmbitoGeografico=2&idEleccion=10&tipoFiltro=ambito_geografico',
  presidencialExterior: API_BASE + '/eleccion-presidencial/participantes-ubicacion-geografica-nombre?tipoFiltro=ambito_geografico&idAmbitoGeografico=2&listRegiones=TODOS&idEleccion=10',
  mesasExterior: API_BASE + '/mesa/totales?tipoFiltro=ambito_geografico&listRegiones=TODOS&ambitoGeografico=2',
